...
$query = mysqli_query($conn,"SELECT logo, companyid FROM company ORDER BY RAND() LIMIT 1");   // ALL companies
// $query = mysqli_query($conn,"SELECT logo, companyid FROM company WHERE companyID=6");  //IMIA 
...
AND newtermid BETWEEN 1 AND 20
ORDER BY RAND() 
LIMIT 1");
...
AND tempterm.tempid = 1 
AND newtermlist.origtermid NOT IN (SELECT termid from tempterm WHERE termid != 1)
AND newtermid BETWEEN 21 AND 40
ORDER BY RAND() 
LIMIT 1");
...
echo '<br><input type="radio" name="opt" value="'.implode(" ",$term1).'"><b><font face="Calibri" color="#00b386">'.implode(" ",$term1).'</font><b></input>';
echo '<br><input type="radio" name="opt" value="'.implode(" ",$term2).'"><font face="Calibri" color="#00b386">'.implode(" ",$term2).'</font><b></input>';
echo '<br><input type="radio" name="opt" value="'.implode(" ",$term3).'"><font face="Calibri" color="#00b386">'.implode(" ",$term3).'</font><b></input>';
echo '<br><input type="radio" name="opt" value="'.implode(" ",$term4).'"><font face="Calibri" color="#00b386">'.implode(" ",$term4).'</font><b></input><br><br>';
