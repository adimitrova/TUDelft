...
session_start();
	...
	if(!isset($_SESSION['userid'])){
		...
		echo '<b><font face="Calibri" color="#00b386">'.$ques.'</font><b>';

		// create temporary table
		$query2 = mysqli_query($conn,"CREATE TABLE IF NOT EXISTS worldofi_mmsr.temp (
		...
		$query3 = mysqli_query($conn,"INSERT INTO `worldofi_mmsr`.`temp` 
