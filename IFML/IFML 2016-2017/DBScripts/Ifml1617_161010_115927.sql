...
alter table `contributions_bysupporters`   add index fk_contributions_bysupporters (`campaigns_oid_camp`), add constraint fk_contributions_bysupporters foreign key (`campaigns_oid_camp`) references `campaigns` (`oid_camp`);
...
alter table `contributions_bysupporters`   add index fk_contributions_bysupporter_2 (`contributionsperks_oid_contr`), add constraint fk_contributions_bysupporter_2 foreign key (`contributionsperks_oid_contr`) references `contributionsperks` (`oid_contr`);
