...
alter table "public"."contributions_bysupporters"   add constraint fk_contributions_bysupporter_2 foreign key ("campaigns_oid_camp") references "public"."campaigns" ("oid_camp");
...
-- Campaigns_Perks [rel6]
create table "public"."campaigns_perks" (
   "campaigns_oid_camp"  int4 not null,
   "contributionsperks_oid_contr"  int4 not null,
  primary key ("campaigns_oid_camp", "contributionsperks_oid_contr")
);
alter table "public"."campaigns_perks"   add constraint fk_campaigns_perks_campaigns foreign key ("campaigns_oid_camp") references "public"."campaigns" ("oid_camp");
alter table "public"."campaigns_perks"   add constraint fk_campaigns_perks_contributio foreign key ("contributionsperks_oid_contr") references "public"."contributionsperks" ("oid_contr");
