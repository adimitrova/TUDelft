...
INSERT INTO `annotation` VALUES (1,10,'Correct Webratio logo ','\0',4);
...
INSERT INTO `item` VALUES (1,'https://s-media-cache-ak0.pinimg.com/564x/c8/44/98/c84498da7ba743ccffd5a17079e90543.jpg','Danbo','Danbo listening to music'),(2,'http://dbgroup.elet.polimi.it/img/logoWebRatio.jpg','Webratio','Logo webratio'),(3,'https://upload.wikimedia.org/wikipedia/en/4/4e/IFML-Interaction-Flow-Modeling-Language-OMG-logo-copyrighted.png','IFML','Logo IFML');
...
INSERT INTO `skill` VALUES (3,'Soft.Eng'),(5,'Web Science'),(17,'Data Mining'),(18,'Crypto'),(20,'Statistics'),(21,'Math'),(22,'Python'),(23,'Java'),(24,'C#'),(25,'MySQL & PHP');
...
INSERT INTO `task` VALUES (1,'Campaign Google Manage AdSense','Setup AdSense',150,'2016-09-21 10:00:00','11:13:40',10,1),(2,'Campaign Google Manage AdWords','Setup',100,'2016-09-20 00:00:00','00:36:38',5,1),(3,'Campaign WebRatio Task 1','Campaign 2 Task 1',50,'2016-09-20 00:00:00','00:36:38',6,2);
...
INSERT INTO `task_item` VALUES (2,1),(3,2),(3,3);
...
INSERT INTO `task_skill` VALUES (2,3),(3,5);
...
INSERT INTO `user` VALUES (1,'work','work','work@work','2015-12-18 00:00:00','Worker',0,0,2),(2,'req','req','req@req.com','2015-12-02 00:00:00','Requester 1',0,0,1),(3,'req2','req2','req2','2016-09-01 00:00:00','Requester 2',0,0,1),(4,'work2','work2','work2@work','2016-09-15 00:00:00','Worker 2',0,0,2);
...
INSERT INTO `user_group` VALUES (1,2),(2,1),(3,1),(4,2);
...
INSERT INTO `user_skill` VALUES (1,3),(1,5),(4,3),(4,5),(4,18);
...
INSERT INTO `user_task` VALUES (1,2),(4,3);
...
-- Dump completed on 2016-10-03 12:57:26
