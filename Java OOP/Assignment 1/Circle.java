...
public class Circle {
	...
	// compare 2 circles
	public boolean equals(Object otherCirc){
		if (otherCirc instanceof Circle){
			Circle circ2 = (Circle) otherCirc ; //make "other" a POINT object to compare it with the first one
